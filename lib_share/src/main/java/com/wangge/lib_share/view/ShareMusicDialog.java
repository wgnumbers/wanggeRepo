...
//
//@Deprecated
//public class ShareMusicDialog extends Dialog {
...
////        other_platforms.add(new ShareEntity(R.mipmap.icon_share_savephotoalbum,"保存相册"));
////        other_platforms.add(new ShareEntity(R.mipmap.icon_share_collect,"收藏"));
////        other_platforms.add(new ShareEntity(R.mipmap.icon_share_nointerest,"不感兴趣"));
...
//
//
//    public ShareMusicDialog(Context context) {
//        super(context, R.style.share_BottomSettingShareDialog);
//        this.context =context;
//        initView();
//    }
//
//    public ShareMusicDialog(Context context, int themeResId) {
